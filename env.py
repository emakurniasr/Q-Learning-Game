...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 8, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(pixels * 1, pixels * 1, anchor='nw', image=self.obstacle6_object)
        # Obstacle 3
        ...
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(pixels * 4, pixels * 4, anchor='nw', image=self.obstacle9_object)
        # Obstacle 8
        ...
        self.flag = self.canvas_widget.create_image(pixels * 8, pixels * 2, anchor='nw', image=self.flag_object)
